...
# print('X: ', len(X_train[1]))
# print('X-2: ', len(X_train[1]) / 2)
# print('X-2: ', int (len(X_train[1]) / 2))
oculta = int (len(X_train[1]) / 2)
print('oculta: ', oculta)
# oculta2 = int (oculta / 2)
# print(oculta2)
# exit()
...
# mlp=MLPClassifier(hidden_layer_sizes= len(X) -2, activation='relu', max_iter=500, alpha=0.0001,
